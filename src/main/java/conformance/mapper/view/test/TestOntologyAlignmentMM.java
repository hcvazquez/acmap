...
public class TestOntologyAlignmentMM {
	...
	private static void executeAllTheTests() {
			...
			ConfigurationManager.setProperty("FL_FILE_PATH", "FeatureLocation/MM_FL.txt");
			...
			printResultsInFile("MM_L",o1,o2,alignament,L);
			printResultsInFile("MM_FL",o1,o2,alignament,FL);
			printResultsInFile("MM_L_FL",o1,o2,alignament,L_FL);
			printResultsInFile("MM_FL_S",o1,o2,alignament,FL_S);
			printResultsInFile("MM_L_S",o1,o2,alignament,L_S);
			printResultsInFile("MM_L_S_H",o1,o2,alignament,L_S_H);
			printResultsInFile("MM_L_FL_S_H",o1,o2,alignament,L_FL_S_H);
	...
	private static void printResultsInFile(String fileName, Ontology o1, Ontology o2, AlignmentImp alignament, boolean[] simF) {
		...
		try
		   {
	       fichero = new FileWriter("Results/"+fileName);
           pw = new PrintWriter(fichero);
           
          /*LinguisticSimilarityFunctionEnabled=false
 		   FeatureLocationAnalysis=true
 		   StructuralSimilarityFunctionEnabled=false
 		   HierarchicalAnalysis=false*/
